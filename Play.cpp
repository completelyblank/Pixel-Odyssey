...
Play::Play(StateManager& sm, View& view, int num, float x, float y) : stateManager(sm), numCoins(num), view(view), hasTransitioned(false) , flag(true), interval(seconds(5.f))
{
    background.setTexture("Assets/Characters/wakeup.jpg");
    soundtrack.openFromFile("Assets/Music/Intro.wav");
