...
void Character::handlemovement(Event& e, float dt, Clock& c, Tiling& tile, Bounds& b, Clock& clock, vector <Sprite> sprites) {
    velocity = { 0.f, 0.f };
    if (Keyboard::isKeyPressed(Keyboard::Up)) {
        frame1.loadFromFile("Assets/Characters/charup1.png");
        frame2.loadFromFile("Assets/Characters/charup2.png");
    ...
    character.move(b.collision(character, velocity, sprites));
}
